---
name: cecistudy-copy
description: Use when writing, editing, or reviewing any user-facing text in the cecistudy project (UI labels, placeholders, empty states, buttons, titles, notifications). The app is entirely in Brazilian Portuguese with a warm, affectionate, personal tone. Follow the lowercase convention and product-specific vocabulary.
---
...
4. Use product vocabulary: "cantinho", "dica do cecinho", "meta do dia",
...
- Avoid rigid/formal language and technical AI jargon.
- Keep accents correct even in lowercase.

## Checklist
- [ ] pt-BR.
- [ ] Lowercase (except CSS-uppercase titles, acronyms, proper names).
- [ ] Warm and affectionate tone.
- [ ] Correct accents.
- [ ] Product vocabulary ("cantinho", "dica do cecinho").
