...
export const ClassNoteModal: React.FC<ClassNoteModalProps> = ({ note, onClose }) => {
  ...
  return (
    <Modal
      open={!!note}
      onClose={onClose}
      className="w-full max-w-sm bg-surface-default rounded-[28px] border border-ceci-border-default shadow-2xl p-6 space-y-4 text-ceci-primary max-h-[85vh] overflow-y-auto"
    >
