...
export const ApproachDetailVerbCard: React.FC<ApproachDetailVerbCardProps> = ({
  ...
  return (
    ...
    >
      <div className="w-10 h-10 rounded-full bg-status-success-surface flex items-center justify-center mb-2">
        <Wrench className="w-5 h-5 text-status-success-strong" />
      </div>
