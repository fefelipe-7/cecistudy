...
describe('PillTabBar', () => {
  it('renderiza todas as abas e marca a ativa', () => {
    render(<PillTabBar tabs={TABS} active="aulas" onChange={() => {}} />);
  ...
  it('chama onChange ao clicar', () => {
    ...
    render(<PillTabBar tabs={TABS} active="aulas" onChange={onChange} />);
  ...
  it('aceita classe customizada', () => {
    const { container } = render(
      <PillTabBar tabs={TABS} active="aulas" onChange={() => {}} className="my-custom" />
    );
