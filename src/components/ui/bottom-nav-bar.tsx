...
export function BottomNavBar({
  ...
  return (
    <motion.nav
      ...
      className={cn(
        "liquid-glass-nav relative rounded-full border shadow-floating w-max max-w-[95vw] h-[52px]",
        className,
      )}
    >
      <div className="relative z-10 flex items-center p-1.5 space-x-1 h-full">
        {items.map((item, idx) => {
