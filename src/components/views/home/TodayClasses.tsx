      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
        {todaySchedule.map(({ course, slot }) => (
          <button
            ...
            className="flex items-center gap-3 p-3.5 rounded-xl bg-white border border-ceci-border-default hover:border-ceci-border-brand shadow-sm tap-interactive active:scale-[0.99] transition-all cursor-pointer text-left"
          >
