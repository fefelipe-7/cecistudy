...
export const TccView: React.FC = () => {
  ...
  return (
    <div className="space-y-4 pb-1">
      ...
      {!hasTcc ? (
        <div className="rounded-2xl p-8 bg-surface-default border border-ceci-border-default shadow-sm text-center space-y-3">
          <Mascote expression="research-tcc" className="w-16 h-16 mx-auto" decorative />
          <h3 className="font-serif-academic text-lg text-ceci-primary">
            ainda não tem tcc
          </h3>
          ...
          <div className="rounded-2xl p-5 bg-surface-default border border-ceci-border-default shadow-sm space-y-3">
            ...
            {tcc.chapters.length > 0 ? (
              ...
              <p className="text-xs text-ceci-secondary bg-surface-muted border border-ceci-border-subtle rounded-2xl p-4 text-center flex items-center justify-center gap-2">
                <Mascote expression="writing-flow" className="w-7 h-7 shrink-0" decorative />
