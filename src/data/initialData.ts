...
export const initialCourses: Course[] = [
  {
    ...
    schedule: [{ day: 1, start: '08:00', end: '11:30' }],
  ...
  },
  {
    ...
    semester: '6º Semestre',
    category: 'obrigatoria',
    schedule: [{ day: 2, start: '14:00', end: '17:30' }],
  ...
  },
  {
    ...
    semester: '6º Semestre',
    category: 'obrigatoria',
    schedule: [{ day: 3, start: '09:00', end: '12:00' }],
  ...
  },
  {
    ...
    semester: '6º Semestre',
    category: 'obrigatoria',
    schedule: [{ day: 4, start: '13:30', end: '17:00' }],
  ...
  },
  {
    ...
    semester: '6º Semestre',
    category: 'obrigatoria',
    schedule: [{ day: 5, start: '08:30', end: '12:30' }],
    room: 'Clínica Escola',
    color: '#E8C98C',
    icon: 'HeartHandshake',
    progress: 75,
