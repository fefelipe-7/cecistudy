...
|---|---|---|
 ...
 | Fase 9 — Builds independentes, sem `isDesktop` no entrypoint | ✅ concluída | — |
  | Fase 10 — Remover pontes (`ScreenLayers`, `AppContext` universal) | 🔄 em progresso (10.0–10.1 desktop feitos; 10.1 mobile/shared pendente) | — |
